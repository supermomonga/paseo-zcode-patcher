export const CURRENT_HOST_PROTOCOL = {
    id: "zcode-task-v1",
    serviceChannels: { agent: "zcode-agent", task: "zcode-task", usage: "usage-stats" },
    operations: {
        cancelGeneration: {
...
export const CURRENT_ZCODE_ARTIFACT = {
...
export function assessCompatibility(identity) {
    if (identity.appVersion !== CURRENT_ZCODE_ARTIFACT.appVersion ||
    ...
    const cliIntegrity = CURRENT_ZCODE_ARTIFACT.cliSha256 === identity.cliSha256 ? "verified" : "modified";
    return {
        status: "supported",
