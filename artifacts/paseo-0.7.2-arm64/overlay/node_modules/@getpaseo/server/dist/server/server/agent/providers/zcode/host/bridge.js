...
export class ZCodeHostBridge {
    ...
    request(method, params, resultSchema, timeoutMs = 30000, diagnosticContext) {
        ...
        }, resultSchema, timeoutMs, diagnosticContext === undefined
            ? undefined
